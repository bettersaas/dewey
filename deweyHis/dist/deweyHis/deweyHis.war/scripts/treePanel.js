...
TreePanel = function(config){
	...
	this.iconPath = 'styles/images/treePanel/';
	this.clickListeners = [];
...
TreePanel.prototype={
	...
	// checkbox的Indeterminate状态
	getIndeterminateChecked : function(name) {
		var checkeds = [];
		name = name||'id';
	...
	// checkbox的checked = false状态
	getNoChecked : function(name){
		var checkeds = [];
		name = name||'id';
		for(var k in this.nodeHash){
			var node = this.nodeHash[k];
